...
CREATE TABLE IF NOT EXISTS USERS(id SERIAL, uuid VARCHAR(200) NOT NULL ,first_name VARCHAR(30) NOT NULL , last_name VARCHAR(30) NOT NULL ,user_name VARCHAR(30) UNIQUE NOT NULL,  email VARCHAR(50) UNIQUE NOT NULL ,password VARCHAR(255) NOT NULL, salt VARCHAR(200) NOT NULL ,country VARCHAR(30) ,about_me VARCHAR(50),dob VARCHAR(30), role VARCHAR(30),contact_number VARCHAR(30), PRIMARY KEY (id));
INSERT INTO users(
	id, uuid, first_name, last_name, user_name, email, password, salt, country, about_me, dob, role, contact_number)
